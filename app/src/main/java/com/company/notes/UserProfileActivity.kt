...
import com.company.notes.databinding.ActivityUserProfileBinding
...
class UserProfileActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btn_click_me = findViewById(R.id.iv_user_photo) as ImageView
        ...
        val btn_click = findViewById(R.id.btn_save) as Button
...
//        hideProgressDialog()
        ...
        //bug
        startActivity(Intent(this@UserProfileActivity, UserHomeActivity::class.java))
    }
