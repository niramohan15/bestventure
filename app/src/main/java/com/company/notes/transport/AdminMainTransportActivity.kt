...
import com.company.notes.databinding.ActivityAdminMainTransportBinding
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.database.*

class AdminMainTransportActivity : AppCompatActivity(), VehicleRVAdapter.VehicleClickInterface {

    private lateinit var binding: ActivityAdminMainTransportBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAdminMainTransportBinding.inflate(layoutInflater)
        ...
        binding.btnAddvehicle.setOnClickListener {
            startActivity(Intent(this, AdminAddTransport::class.java))
        }
