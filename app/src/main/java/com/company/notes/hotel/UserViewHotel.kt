...
import com.company.notes.databinding.ActivityUserViewHotelBinding
import com.google.firebase.database.*


class UserViewHotel : AppCompatActivity(), HotelRVAdapter.HotelClickInterface {

    private lateinit var binding: ActivityUserViewHotelBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityUserViewHotelBinding.inflate(layoutInflater)
    ...
    override fun onHotelClick(position: Int) {
        val intent = Intent(this, UserViewSpecificDetails::class.java)
