...
import com.company.notes.databinding.ActivityAdminMainSightBinding
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.database.*

class AdminMainSightActivity : AppCompatActivity(), SightRVAdapter.SightClickInterface {

    private lateinit var binding: ActivityAdminMainSightBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAdminMainSightBinding.inflate(layoutInflater)
...
//        ! Add sight ButtonAdmin Add sightssss Detailsssssssssssssss
        binding.btnAddsight.setOnClickListener {
            startActivity(Intent(this, AdminAddSights::class.java))
        }
